...
var _632=$("<input height=\"20px\" type=\"text\" class=\"datagrid-editable-input\">").appendTo(_630);
_632.numberbox(_631);
return _632;
...
$(_635).numberbox("setValue",_636);
	...
	var _g="";
$(_637)._outerWidth(_638)._outerHeight(_g);
...
_707.push("<td style=\"border:0;text-align:center;width:25px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:20px;cursor:pointer\">&nbsp;</span></td>");
}
