package com.infotop.webharvest.pagedatainfo.web;
...
/**
 * PagedatainfoAction
 * $Id: PagedatainfoAction.java,v 0.0.1 2015-02-17 11:06:13  $
 */
@Controller
@RequestMapping(value = "/pagedatainfo")
public class PagedatainfoController extends BasicController {
	...
	public String list(Model model, ServletRequest request) {
       ...
       return "pagedatainfo/pagedatainfoList";
    }
	...
	public DataGrid findList(
		...
		try {
			...
			if (user != null) {
				...
				dataGrid = pagedatainfoService.dataGrid(searchParams, pageNumber,
						rows, sortType, order);
			} else {
				logger.log(this.getClass(),Logger.ERROR_INT,"登陆帐号无效!","",null);
			}
	 ...
	 */
	 ...
	 public String createForm(Model model) {
	     ShiroUser su = super.getLoginUser();
			User user = accountService.findUserByLoginName(su.getLoginName());
			if (user != null) {
				 Pagedatainfo entity = new Pagedatainfo(); 
	 ...
	 */
	 ...
	 @ResponseBody
	 public Message create(@Valid Pagedatainfo pagedatainfo, RedirectAttributes redirectAttributes) {
		try {
			ShiroUser su = super.getLoginUser();
			User user = accountService.findUserByLoginName(su.getLoginName());
			if (user != null) {
	 ...
	 */
	 @RequestMapping(value = "update/{id}", method = RequestMethod.GET)
	    public String updateForm(@PathVariable("id") Long id, Model model) {
			...
			User user = accountService.findUserByLoginName(su.getLoginName());
			if (user != null) {
				Pagedatainfo entity = pagedatainfoService.get(id); 
		        model.addAttribute("pagedatainfo", entity);
	 ...
	 */
	 ...
	 @ResponseBody
	    public Message update(@Valid @ModelAttribute("preloadPagedatainfo") Pagedatainfo pagedatainfo,
	 ...
	 @ResponseBody
	    public Message delete(@RequestParam(value = "ids") List<Long> ids,
	     ...
	     try {
				...
				User user = accountService.findUserByLoginName(su.getLoginName());
				if (user != null) {
					pagedatainfoService.delete(ids);
					msg.setSuccess(true);
	 ...
	 @RequestMapping(value = "view/{id}", method = RequestMethod.GET)
	    public String view(@PathVariable("id") Long id, Model model) {
			...
			if (user != null) {
		 	...
		 	return "pagedatainfo/pagedatainfoView";
	    }
	 
	 
	   @ModelAttribute("preloadPagedatainfo")
	    public Pagedatainfo getPagedatainfo(@RequestParam(value = "id", required = false) Long id) {
	        if (id != null) {
	            return pagedatainfoService.get(id);
	        }
	        return null;
	    }
